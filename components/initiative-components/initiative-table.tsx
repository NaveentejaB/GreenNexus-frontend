    ...
    return(
        <div className="w-full overflow-x-auto">
            <Table className="min-w-[1000px]">
                <TableHeader>
                    <TableRow>
                    <TableHead className="w-[240px] text-center">Initiative</TableHead>
                ...
                <TableBody>
                    {iniTableData.map((item,idx)=>(
                        <TableRow className="text-black text-sm py-1 h-10" key={idx}>
                            ...
                            <TableCell className="text-center">{item.no_of_persons}</TableCell>
                            <TableCell className="text-center">{item.max_no}</TableCell>
